...
class AgentDefinitionSnapshot:
    ...
    """Optional deterministic workflow bound to this agent version.

    When present, the runtime uses ``WorkflowEngine`` instead of the
    default Agent Loop for execution. Generated by ``WorkflowGenerator``
    from user intent + agent capabilities."""
