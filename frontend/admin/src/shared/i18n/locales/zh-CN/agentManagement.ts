...
export const agentManagement = {
      ...
      agents: {
        ...
        detail: {
          ...
          setupDescription: '选择模型并添加 Instructions，即可创建第一个草稿。',
          setupAgentCreated: 'Agent 已创建',
          setupModel: '选择模型',
          setupInstructions: '添加 Instructions',
          publishedReadonlyInfo: '已发布版本不可直接修改。点击编辑会创建新的草稿。',
          ...
          noRuns: '暂无运行记录。测试或执行此 Agent 后，运行记录将显示在此处。',
          evaluationUnavailable: '当前 Agent API 未提供 Agent 级评估数据。',
          tools: '工具',
          skills: '技能',
          mcpServers: 'MCP 服务器',
          manageTools: '浏览全局工具注册表',
          manageSkills: '浏览全局技能注册表',
          manageMcpServers: '浏览全局 MCP 注册表',
          metrics: {
            status: '状态',
            version: '版本',
            successRate: '成功率',
