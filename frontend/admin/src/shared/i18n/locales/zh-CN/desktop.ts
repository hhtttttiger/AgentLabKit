export const desktop = {
  ...
  home: {
    ...
    activity: '活动', recentRuns: '最近运行', viewAll: '查看全部', noRuns: '暂无运行记录。下一次 Agent 运行会显示在这里。',
