...
export const agentManagement = {
  ...
  agents: {
    ...
    detail: {
      ...
      setupDescription: 'Choose a model and add instructions to create the first draft.',
      setupAgentCreated: 'Agent created',
      setupModel: 'Choose a model',
      setupInstructions: 'Add instructions',
      publishedReadonlyInfo: 'This published version is read-only. Edit it to create a new draft.',
      ...
      noRuns: 'No runs yet. Runs will appear here after you test or execute this Agent.',
      evaluationUnavailable: 'Agent-scoped evaluation data is not available.',
      tools: 'Tools',
      skills: 'Skills',
      mcpServers: 'MCP Servers',
      manageTools: 'Browse global tool registry',
      manageSkills: 'Browse global skill registry',
      manageMcpServers: 'Browse global MCP registry',
      metrics: {
        status: 'Status',
        version: 'Version',
